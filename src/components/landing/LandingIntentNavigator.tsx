...
const INTENTS: LandingIntent[] = [
  ...
  },
  {
    ...
    description: "Start with foundations, follow cataloged references, build something practical, and know what proof to collect before moving on.",
    start: "Question",
    ...
    links: [
      ...
      { title: "Resource Library", description: "Browse official documentation, standards, and durable learning sources.", href: "/resources", meta: "Cataloged references" },
