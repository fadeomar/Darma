...
export default function BoxShadowsGeneratorClient() {
  ...
  const previewSlot = (
    <div className="space-y-4">
      ...
      <div className="flex min-h-[520px] items-center justify-center rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[radial-gradient(circle_at_top_left,var(--color-primary-soft),transparent_34%),linear-gradient(135deg,var(--color-preview-bg),var(--color-preview-bg-strong))] p-8">
        <div
