    ...
    <article className={cn(
      ...
      <div className="space-y-3 p-3.5">
        <div className="flex items-start justify-between gap-3">
          ...
          {preset.cssOnly ? <span className="shrink-0 rounded-full border border-[var(--color-border-subtle)] px-2 py-1 font-mono text-[9px] font-bold uppercase tracking-[0.08em] text-[var(--color-text-tertiary)]">CSS only</span> : null}
        </div>
  ...
  return (
    <section className="space-y-4 rounded-[var(--radius-lg)] border border-[var(--color-border-default)] bg-[var(--color-surface)] p-4 shadow-[var(--shadow-xs)] sm:p-5">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
        <div>
          <div className="font-mono text-[10px] font-bold uppercase tracking-[0.12em] text-[var(--color-primary)]">Explore first</div>
