...
export const metadata: Metadata = {
  ...
  description:
    "Darma is an open-source technology workspace with browser tools, trusted developer resources, learning paths, career guides, software workflow references, and practical comparisons.",
  ...
  openGraph: {
    ...
    description: "Use practical browser tools, follow reviewed learning paths, compare technology choices, and explore trusted developer resources.",
    url: absoluteUrl("/"),
  ...
  twitter: {
    ...
    title: "Darma — open tools and a connected technology atlas",
    description: "Practical developer tools, trusted resources, learning paths, careers, workflows, and reviewed technology guides.",
