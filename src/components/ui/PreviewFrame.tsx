...
const variantClass: Record<PreviewFrameVariant, string> = {
  default: "bg-[var(--color-preview-bg)] border border-[var(--color-preview-border)]",
  studio: "bg-[var(--color-preview-bg-strong)] border border-[var(--color-preview-border)]",
  checkerboard: [
  ...
  code: "bg-[var(--color-code-bg)] border border-[var(--color-code-border)]",
