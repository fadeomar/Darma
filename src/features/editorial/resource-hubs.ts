...
export const RESOURCE_HUBS: ResourceHub[] = [
  ...
  },
  {
    ...
    summary: "Cataloged JavaScript, TypeScript, React, Next.js, Vue, Angular, Node.js, and ecosystem references organized around real learning decisions.",
  ...
  },
  {
    ...
    summary: "Cataloged references for Git, CI/CD, containers, cloud delivery, observability, reliability, and secure software operations.",
