...
export const QR_PRESETS: QRPreset[] = [
  ...
  {
    id: "product-page",
    title: "Product page QR",
    description: "Link packaging or shelf signage to a product page.",
    values: { type: "url", url: "https://example.com/products/focus-lamp" },
  },
  {
    id: "feedback-form",
    title: "Customer feedback QR",
    description: "Send customers directly to a feedback or survey form.",
    values: { type: "url", url: "https://example.com/feedback" },
  },
  {
    id: "portfolio",
    title: "Portfolio QR",
    description: "A simple portfolio link for resumes, business cards, or event badges.",
    values: { type: "url", url: "https://example.com/portfolio" },
  },
  {
    id: "email-support",
    title: "Support email QR",
    description: "Open a pre-addressed support email with a useful subject.",
    values: { type: "email", emailTo: "support@example.com", emailSubject: "Support request", emailBody: "Hi, I need help with my order." },
  },
  {
    id: "phone-reception",
    title: "Reception phone QR",
    description: "Start a call from signage, a brochure, or a contact sheet.",
    values: { type: "phone", phone: "+15551234567" },
  },
  {
    id: "sms-checkin",
    title: "SMS check-in QR",
    description: "Prepare a short check-in message for an event or service desk.",
    values: { type: "sms", smsPhone: "+15551234567", smsMessage: "Hi, I have arrived for my appointment." },
  },
  {
    id: "whatsapp-support",
    title: "WhatsApp support QR",
    description: "Open a support conversation with a prepared first message.",
    values: { type: "whatsapp", whatsappPhone: "+15551234567", whatsappMessage: "Hi, I need support with my account." },
  },
  {
    id: "guest-wifi-open",
    title: "Open guest WiFi QR",
    description: "Share a network that does not require a password.",
    values: { type: "wifi", wifiSsid: "Community Guest", wifiEncryption: "nopass" },
  },
  {
    id: "hidden-wifi",
    title: "Hidden WiFi QR",
    description: "Share credentials for a hidden WPA network.",
    values: { type: "wifi", wifiSsid: "Studio Private", wifiPassword: "replace-this-password", wifiEncryption: "WPA", wifiHidden: true },
  },
  {
    id: "conference-contact",
    title: "Conference contact QR",
    description: "A fuller contact card for networking and conference badges.",
    values: {
      type: "vcard",
      contactFirstName: "Alex",
      contactLastName: "Morgan",
      contactOrg: "Example Studio",
      contactTitle: "Product Designer",
      contactPhone: "+15551234567",
  ...
  {
    id: "store-location",
    title: "Store location QR",
    description: "Open coordinates for a shop, venue, pickup point, or meeting place.",
    values: { type: "location", latitude: "40.7128", longitude: "-74.0060", locationLabel: "Pickup point" },
  },
  {
    id: "workshop-event",
    title: "Workshop calendar QR",
    description: "Share a workshop with time, place, and a short attendee note.",
    values: {
      type: "event",
      eventTitle: "Design Systems Workshop",
      eventStart: "2026-09-15T10:00",
      eventEnd: "2026-09-15T12:00",
      eventLocation: "Workshop Room A",
      eventDescription: "Bring a laptop and charger.",
    },
  },
  {
    id: "emergency-note",
    title: "Plain-text emergency note",
    description: "Encode a short offline instruction or reference code without a URL.",
    values: { type: "text", text: "Emergency contact desk: Building B, reception level." },
  },
  {
    id: "simple-website",
