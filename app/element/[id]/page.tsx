    ...
    >
      ...
      <main className="container mx-auto px-4 py-6 grid grid-cols-1 lg:grid-cols-[1fr_250px] gap-6">
        ...
        <div
          ...
          style={{
            width: containerWidth ? `${containerWidth}px` : "auto", // Explicitly set width
            maxWidth: containerWidth ? `${containerWidth}px` : "100%", // Prevent overflow
            minWidth: containerWidth ? `${containerWidth}px` : "auto", // Force shrink
          }}
        >
          {/* Preview Section */}
