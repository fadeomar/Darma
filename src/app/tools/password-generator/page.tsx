  ...
  return (
    <ToolPageShell
      ...
      intro={
        <p className="max-w-2xl text-sm leading-7 text-slate-700 dark:text-slate-300">
          Cryptographically random passwords and passphrases, generated entirely
        ...
        <div className="flex flex-col gap-5">
          ...
          <SurfaceCard>
            ...
            <ul className="mt-3 space-y-2.5 text-sm leading-6 text-slate-700 dark:text-slate-300">
              <li>
                <strong className="text-slate-900 dark:text-slate-100">16 characters</strong> is
                the minimum for important accounts.
              </li>
              <li>
                Use a <strong className="text-slate-900 dark:text-slate-100">passphrase</strong> for
                your master password — easier to remember, still very strong.
              </li>
              <li>
    ...
    >
      <ToolContentCard
        ...
        description="Settings update the password instantly. Use the colour coding to confirm all selected character types are present."
      >
